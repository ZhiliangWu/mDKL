...
def run_lr(batch_size=64, lr=3e-4, alpha=0.1, model_name='resnet', epoch=50,
    ...
    Args:
        ...
        augm (bool): Whether use data augmentation.
    ...
    model = get_model(model_name, pretrain=pretrain, output_dim=4, dropout=True)
...
if __name__ == '__main__':
    ...
    r_name = f'{m_name}_linear_regressor_albu_dropout'
